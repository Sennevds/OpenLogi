...
/// overlay exactly like a mouse button's — the *Buttons* profile bar is the
/// right one here, because it drives the same `editing_app` scope the crown
/// panel commits through. (The Keys tab has no equivalent: F-row triggers live
